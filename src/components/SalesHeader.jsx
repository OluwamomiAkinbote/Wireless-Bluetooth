  ...
  return (
    <header className=" relative w-full flex flex-col items-center justify-center text-center text-gray-300 px-4 py-6 mb-6 border-2 border-dashed border-maroon-700">
      ...
      <div className="relative z-10 max-w-6xl">
        ...
        <p className="mt-4 text-md md:text-xl text-purple-200">
        ...
        <div className="mt-6 flex flex-col md:flex-row justify-center gap-4">
          <button
            ...
            className="bg-yellow-700 text-gray-950 text-xl font-bold py-3 px-8 rounded-md shadow-[6px_6px_12px_#1a1a1a,-6px_-6px_12px_#2a2a2a] 
